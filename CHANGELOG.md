...
### Changed
- Replace `AcceptsJson` trait with explicit `defaultHeaders()` on `LumaConnector` for both `Content-Type` and `Accept` headers
- Promote all 26 Response DTOs to `readonly class` for stronger immutability guarantees
- Upgrade PHPStan static analysis from level 5 to level 8

## [0.2.1] - 2026-04-02

### Fixed
- Fix Style workflow failing with 403 by adding `contents: write` permission to `pint.yml`
- `ordered_imports` lint violation in `EventResourceTest.php`
...
[Unreleased]: https://github.com/laravel-gtm/luma-sdk/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/laravel-gtm/luma-sdk/compare/v0.2.1...v0.3.0
[0.2.1]: https://github.com/laravel-gtm/luma-sdk/compare/v0.2.0...v0.2.1
